...
Instead of ActionMailer, let's use the Pony gem.  You can still use ActionMailer (>= 3.0.0rc2) if you wish but we're going to use Pony gor these examples.  If you don't have Pony, install it by doing:
